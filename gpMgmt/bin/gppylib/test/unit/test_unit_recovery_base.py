...
class RecoveryBaseTestCase(GpTestCase):
    def setUp(self):
        ...
        self.incr_r2 = RecoveryInfo('target_data_dir2', 5002, 2, 2, 'source_hostname2',
...
class SetCmdResultsTestCase(GpTestCase):
    ...
    def test_set_recovery_cmd_results_catch_exception(self):
        ...
        recovery_info = RecoveryInfo('/tmp/datadir2', 7002, 2, 2, None, None, None, None, None, '/tmp/progress_file2')
