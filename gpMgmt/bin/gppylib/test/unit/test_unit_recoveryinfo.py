        ...
        tests = [
            {
                ...
                "expected": {'sdw3': [RecoveryInfo('/data/mirror3', 7000, 7, 7, 'sdw2', 3000, '/data/primary3',
                                                    True, False, '/tmp/logdir/pg_basebackup.111.dbid7.out'),
                                      RecoveryInfo('/data/mirror4', 8000, 8, 8, 'sdw3', 4000, '/data/primary4',
                                                    False, False, '/tmp/logdir/pg_rewind.111.dbid8.out'),
                                      RecoveryInfo('/data/mirror3', 7000, 7, 9, 'sdw2', 3000, '/data/primary3',
            ...
            },
            {
                ...
                "expected": {'sdw4': [RecoveryInfo('/data/mirror5', 9000, 5, 5, 'sdw1', 1000, '/data/primary1',
                                                    True, False, '/tmp/logdir/pg_basebackup.111.dbid5.out'),
                                      RecoveryInfo('/data/mirror6', 10000, 6, 6, 'sdw2', 2000, '/data/primary2',
            ...
            },
            {
                ...
                "expected": {'sdw2': [RecoveryInfo('/data/mirror1', 5000, 5, 5, 'sdw1', 1000, '/data/primary1',
                                                    True, False, '/tmp/logdir/pg_basebackup.111.dbid5.out')],
                             'sdw1': [RecoveryInfo('/data/mirror2', 6000, 6, 6, 'sdw2', 2000, '/data/primary2',
                                                    True, False, '/tmp/logdir/pg_basebackup.111.dbid6.out')]}
            },
            {
            ...
            },
            {
                ...
                "expected": {'sdw2': [RecoveryInfo('/data/mirror1', 5000, 5, 5, 'sdw1', 1000, '/data/primary1',
                                                    True, False, '/tmp/logdir/pg_basebackup.111.dbid5.out')],
                             'sdw3': [RecoveryInfo('/data/mirror3', 7000, 7, 7, 'sdw2', 3000, '/data/primary3',
            ...
            },
            {
                ...
                "expected": {'sdw4': [RecoveryInfo('/data/mirror5', 9000, 5, 5, 'sdw1', 1000, '/data/primary1',
                             ...
                             'sdw1': [RecoveryInfo('/data/mirror2', 6000, 6, 6, 'sdw2', 2000, '/data/primary2',
                                      ...
                                      RecoveryInfo('/data/mirror8', 12000, 8, 8,
