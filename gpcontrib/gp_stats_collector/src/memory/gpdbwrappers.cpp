...
void *gpdb::palloc(Size size) { return wrap_throw(::palloc, size); }

void *gpdb::palloc0(Size size) { return wrap_throw(::palloc0, size); }

char *gpdb::pstrdup(const char *str) { return wrap_throw(::pstrdup, str); }
...
ExplainState gpdb::get_analyze_state(QueryDesc *query_desc,
...
void gpdb::insert_log(const gpsc::SetQueryReq &req, bool utility) {
