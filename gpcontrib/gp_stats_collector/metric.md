...
| `plan_json`                  | string | T       | ABS      | -      | Cluster |     +      |    -    | text    | EXPLAIN (FORMAT JSON), if gpsc.enable_json_plan      |
...
| `analyze_json`               | string | D       | ABS      | -      | Cluster |     +      |    -    | text    | EXPLAIN ANALYZE (FORMAT JSON), if gpsc.enable_json_plan |
| **AdditionalQueryInfo**      |        |         |          |        |         |            |         |         |                                                     |
