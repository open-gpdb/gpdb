...
typedef struct MotionWithParamContext
{
	...
	Bitmapset  *nestLoopParams; /* Params generated by initplans */
} MotionWithParamContext;

/*
 * plan->extParam contains epqParams of ModifyTable, LockRows and wtParams
 * of WorkTableScan. These params are used in concurrent updates.
 * They are processed in Executor stage.
 * In Planner We remove them from extParam.
 */
static bool
