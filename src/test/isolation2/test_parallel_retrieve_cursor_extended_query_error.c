...
main(int argc, char **argv)
{
	...
	/* create gp_parallel_retrieve_cursor extension */
	if (exec_sql_without_resultset(master_conn, "CREATE EXTENSION IF NOT EXISTS gp_parallel_retrieve_cursor WITH SCHEMA pg_catalog;", MASTER_CONNECT_INDEX) != 0)
		goto LABEL_ERR;
	...
	/* drop gp_parallel_retrieve_cursor extension */
	if (exec_sql_without_resultset(master_conn, "DROP EXTENSION gp_parallel_retrieve_cursor;", MASTER_CONNECT_INDEX) != 0)
		goto LABEL_ERR;
