...
static ForeignScan *
extended_protocol_commit_test_fdw_GetForeignPlan(PlannerInfo *root, RelOptInfo *baserel, unsigned int foreigntableid, ForeignPath *best_path, List *tlist, List *scan_clauses)
{
