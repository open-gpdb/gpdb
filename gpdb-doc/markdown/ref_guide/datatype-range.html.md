...
See [Range Functions and Operators](function-summary.html) for complete lists of operators and functions on range types.
...
## <a id="rangetypes-discrete"></a>Discrete Range Types 
