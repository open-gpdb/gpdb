...
1. Download the `plcontainer-python3-image-2.2.0-gp6.tar.gz` file from the **Greenplum Procedural Languages** section on [VMware Tanzu Network](https://network.pivotal.io/products/VMware-Greenplum).
